...
export default function Presentation() {
  return (
    <div className="w-full h-full mt-auto mb-36">
      <Image className="w-1/3 absolute top-10 right-10" src={Portrait} alt="portrait"/>
      <div className="pl-24 font-semibold text-8xl flex flex-col">
